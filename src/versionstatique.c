 ...
 * versionstatique.c
 * 
 * © Copyright 2024 E. Huot <etienne.huot@uvsq.fr>
 * 
...
void lecture_style()
{
/* We could have used a CSS file, but it is sometimes     */
/* more practical to define the style within the HTML     */
/* code generated by this CGI-BIN.                        */
/* We read this style from the file "aecrire.html"        */
/* and then display it.                                   */
/*                                                        */
/* An attentive student will easily notice that this      */
/* function may not be useless for their own needs...     */
...
/*
 * Note that for the web, accented characters have been 
 * transformed because C character strings are natively 
 * encoded in ASCII and not in UTF-8.
 * A student eager to do things properly should normally 
 * preprocess all accents before displaying them in HTML.
 */
  ...
  printf("    <ul>\n");
/*
 * Each bar of the histogram is placed every 31 pixels.
 * The label here corresponds to the height/10. 
 * Labels for heights < 25, are not displayed as it would not fit into the bar		.
 */
...
{
/*
 * We avoid accented letters in the shell
 */
